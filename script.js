    document.querySelectorAll('.gift').forEach(gift => {
        ...
        // Replace the gift with the message
...
There is truly no one else as kind, caring, understanding and funny as you. You’re genuinely perfect and I am so proud of you and the man you’ve become.

Here’s to many more (white) Christmases together and hours spent cuddling underneath blankets by a fireplace.

Sending unlimited kisses and cuddles, 
Your magic star
        `;
